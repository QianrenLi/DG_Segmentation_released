...
# ################### Log File Read ########################
# log_file_name = ('./no_DG_epoch_DICE_%d.txt')%(epoch_number)
# log_file_name = ('./DG_epoch_%d.txt')%(epoch_number)
# log_file_name = ('./Data_arg_no_DG_DICE_epoch_%d.txt')%(epoch_number)
log_file_name = ('./Data_arg_no_DG_epoch_%d.txt') % (epoch_number)
# log_file_name = ('./Data_DG_D1_epoch_%d.txt')%(epoch_number)
# log_file_name = ('./Data_arg_DG_epoch_s03_r1_t%d.txt')%(epoch_number)
...
no_DG_epoch = ('./no_DG_epoch_DICEBCE_%d.txt')%(epoch_number)
loss_DICE_CE = loss_read(no_DG_epoch)

no_DG_cross_entropy = ('./no_DG_epoch_cross_entropy_%d.txt')%(epoch_number)
...
# PATH = ('./no_DG_epoch_DICEBCE_%d.txt')%(epoch_number)
# loss1 = loss_read(PATH)
# PATH = ('./DG_epoch_%d.txt') % (epoch_number)
# loss2 = loss_read(PATH)
# PATH = ('./Data_arg_no_DG_epoch_%d.txt') % (epoch_number)
# loss1 = loss_read(PATH)
# PATH = ('./Data_arg_DG_epoch_s03_r05_t%d.txt') % (epoch_number)
# loss2 = loss_read(PATH)
...
PATH = ('./no_DG_epoch_DICE_%d.txt')%(epoch_number)
loss2 = loss_read(PATH)
PATH = ('./no_DG_epoch_DICE_t%d.txt') % (epoch_number)
loss1 = loss_read(PATH)
...
Arg_DICE = ('./Data_arg_no_DG_DICE_epoch_%d.txt')%(epoch_number)
